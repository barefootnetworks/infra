...
$(BINARY_DIR)/$(BINARY): $($(BINARY)_LIBRARIES)
	...
	$(VERBOSE)$(GCC_LN) $(DEBUG_FLAGS) $(COVERAGE_FLAGS) -o $@ $($(BINARY)_LINK_LIBS) $($(BINARY)_EXTRA_LINK_LIBS) $(GLOBAL_LINK_LIBS) $($(BINARY)_LINK_LIBS) $($(BINARY)_EXTRA_LINK_LIBS) $(GLOBAL_LINK_LIBS) $($(BINARY)_LINK_LIBS) $($(BINARY)_EXTRA_LINK_LIBS) $(GLOBAL_LINK_LIBS) $(LDFLAGS)
